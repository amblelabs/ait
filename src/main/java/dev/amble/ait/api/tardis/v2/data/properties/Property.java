...
public class Property<T> {
    ...
    protected final Function<TData.Props<?>, T> def;

    public Property(PropertyType<T> type, String name, Function<TData.Props<?>, T> def) {
        this.type = type;
        this.name = name;
        this.def = def;
    }
    ...
    public Value<T> create(TData.Props<?> holder) {
