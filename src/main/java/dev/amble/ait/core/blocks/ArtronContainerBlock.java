...
import dev.amble.ait.core.blockentities.ArtronContainerBlockEntity;
import dev.amble.ait.core.blocks.types.HorizontalDirectionalBlock;

public class ArtronContainerBlock extends HorizontalDirectionalBlock implements BlockEntityProvider {

    protected static final VoxelShape Y_SHAPE = Block.createCuboidShape(6.0, 0.0, 6.0, 10.0, 29.0, 10.0);

    public ArtronContainerBlock(Settings settings) {
        super(settings);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(@NotNull World world, @NotNull BlockState state,
        ...
        return (world1, blockPos, blockState, ticker) -> {
            if (ticker instanceof ArtronContainerBlockEntity collector) {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ArtronContainerBlockEntity(pos, state);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
        ...
        if (blockEntity instanceof ArtronContainerBlockEntity artronContainerBlockEntity)
            artronContainerBlockEntity.useOn(world, player.isSneaking(), player);
