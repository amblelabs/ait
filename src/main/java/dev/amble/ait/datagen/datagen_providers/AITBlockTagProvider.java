...
public class AITBlockTagProvider extends AmbleBlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        //TODO: Make the glass tag work on this and the leaves, for now there's just glass and glass pane and the birch leaves as a temporary thing.
        getOrCreateTagBuilder(AITTags.Blocks.SONIC_INTERACTABLE)
