...
public class AITModDataGenerator implements DataGeneratorEntrypoint {
    ...
    public AmbleLanguageProvider addEnglishTranslations(FabricDataOutput output,
        ...
        // TARDIS Temperament config
        provider.addTranslation("yacl3.config.ait:server.category.tardis_temperament", "TARDIS Temperament");
        provider.addTranslation("yacl3.config.ait:server.tardisTemperament", "Enable TARDIS Temperament");
        provider.addTranslation("yacl3.config.ait:server.temperamentHomeRadius", "Temperament Home Radius (Blocks)");
        provider.addTranslation("yacl3.config.ait:server.temperamentApproachRadius", "Rejected Player Approach Radius (Blocks)");
        provider.addTranslation("yacl3.config.ait:server.temperamentApproachTrackingRadius", "Approach Tracking Radius (Blocks)");
        provider.addTranslation("yacl3.config.ait:server.temperamentCompanionSafetyRadius", "Companion Safety Radius (Blocks)");
        provider.addTranslation("yacl3.config.ait:server.temperamentKeyRadius", "Linked Key Reaction Radius (Blocks)");
        provider.addTranslation("yacl3.config.ait:server.temperamentKeyPickupDelayTicks", "Burned Key Pickup Delay (Ticks)");
        provider.addTranslation("yacl3.config.ait:server.temperamentHopDistance", "Evasive Hop Distance (Blocks)");
        provider.addTranslation("yacl3.config.ait:server.temperamentHopAngleSpreadDegrees", "Evasive Hop Angle Spread (Degrees)");
        provider.addTranslation("yacl3.config.ait:server.temperamentMaxApproachStep", "Maximum Continuous Approach Step");
        provider.addTranslation("yacl3.config.ait:server.temperamentHopChance", "Evasive Hop Chance (%)");
        provider.addTranslation("yacl3.config.ait:server.handlesRejectWarningChance", "Handles REJECT Warning Chance (%)");
        provider.addTranslation("yacl3.config.ait:server.handlesZeroLoyaltyRejectWarningChance", "Handles Zero-Loyalty Warning Chance (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentCamouflageChance", "Temporary Camouflage Chance (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentCloakChance", "Temporary Cloak Chance (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentLeftBehindChance", "Leave REJECT Players Behind Chance (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingChance", "Unsafe Landing Chance (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentFailedEventGravityChance", "Failed Event Gravity Reaction Chance (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentKeyBurnChance", "Linked Key Burn Chance (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentKeyFireSeconds", "Linked Key Fire Duration (Seconds)");
        provider.addTranslation("yacl3.config.ait:server.temperamentDoorCloseChance", "Rejected Entry Door-Close Chance (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentDoorEntryTriggerRadius", "Rejected Entry Trigger Radius (Blocks)");
        provider.addTranslation("yacl3.config.ait:server.temperamentGravityDurationSeconds", "Gravity Reaction Duration (Seconds)");
        provider.addTranslation("yacl3.config.ait:server.temperamentBrokenKeyLoyaltyPenalty", "Broken Key Loyalty Penalty");
        provider.addTranslation("yacl3.config.ait:server.temperamentHammerCooldownTicks", "Hammer Reaction Cooldown (Ticks)");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingHorizontalRadius", "Unsafe Landing Horizontal Radius");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingVerticalRadius", "Unsafe Landing Vertical Radius");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingColumnAttempts", "Unsafe Landing Column Attempts");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingLocalColumnAttempts", "Unsafe Landing Local Attempts");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingHostileAttempts", "Unsafe Landing Hostile Attempts");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingHostileCaptureRadius", "Unsafe Landing Hostile Capture Radius");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingVoidHeight", "Unsafe Landing Void Height");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingBuildLimitMargin", "Unsafe Landing Build-Limit Margin");
        provider.addTranslation("yacl3.config.ait:server.temperamentPassiveLoyaltyLossChance", "Passive REJECT Loyalty Loss Chance (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentPassiveLoyaltyLoss", "Passive REJECT Loyalty Loss");
        provider.addTranslation("yacl3.config.ait:server.temperamentJealousyAbsenceMinutes", "Jealousy Absence Time (Minutes)");
        provider.addTranslation("yacl3.config.ait:server.temperamentJealousySameOrLowerPenalty", "Same-or-Lower Loyalty Jealousy Penalty");
        provider.addTranslation("yacl3.config.ait:server.temperamentJealousyHigherPenalty", "Higher Loyalty Jealousy Penalty");
        provider.addTranslation("yacl3.config.ait:server.temperamentHomeRelocationLoyaltyPenalty", "Home Relocation Loyalty Penalty");
        provider.addTranslation("yacl3.config.ait:server.temperamentHomeOverlapLoyaltyPenalty", "Overlapping Home Loyalty Penalty");
        provider.addTranslation("yacl3.config.ait:server.temperamentHomeOverlapPenaltyIntervalSeconds", "Overlapping Home Penalty Interval (Seconds)");
        provider.addTranslation("yacl3.config.ait:server.temperamentConsoleRejectionPushHorizontal", "Console Rejection Horizontal Force");
        provider.addTranslation("yacl3.config.ait:server.temperamentConsoleRejectionPushVertical", "Console Rejection Vertical Force");
        provider.addTranslation("yacl3.config.ait:server.timelineErasureEnabled", "Enable Timeline Erasure");
        provider.addTranslation("message.ait.handles.reject_warning", "I would not test her patience right now.");
        provider.addTranslation("death.attack.timeline_erasure", "%1$s was erased from the timeline");
    ...
    public AmbleLanguageProvider addSpanishTranslations(FabricDataOutput output,
        ...
        // Configuración de Temperamento de la TARDIS
        provider.addTranslation("yacl3.config.ait:server.category.tardis_temperament", "Temperamento de la TARDIS");
        provider.addTranslation("yacl3.config.ait:server.tardisTemperament", "Activar Temperamento de la TARDIS");
        provider.addTranslation("yacl3.config.ait:server.temperamentHomeRadius", "Radio del hogar para el temperamento (bloques)");
        provider.addTranslation("yacl3.config.ait:server.temperamentApproachRadius", "Radio de aproximación de jugadores REJECT (bloques)");
        provider.addTranslation("yacl3.config.ait:server.temperamentApproachTrackingRadius", "Radio de seguimiento de aproximación (bloques)");
        provider.addTranslation("yacl3.config.ait:server.temperamentCompanionSafetyRadius", "Radio de seguridad de acompañantes (bloques)");
        provider.addTranslation("yacl3.config.ait:server.temperamentKeyRadius", "Radio de reacción a llaves vinculadas (bloques)");
        provider.addTranslation("yacl3.config.ait:server.temperamentKeyPickupDelayTicks", "Espera para recoger una llave quemada (ticks)");
        provider.addTranslation("yacl3.config.ait:server.temperamentHopDistance", "Distancia del salto evasivo (bloques)");
        provider.addTranslation("yacl3.config.ait:server.temperamentHopAngleSpreadDegrees", "Dispersión angular del salto evasivo (grados)");
        provider.addTranslation("yacl3.config.ait:server.temperamentMaxApproachStep", "Paso máximo de aproximación continua");
        provider.addTranslation("yacl3.config.ait:server.temperamentHopChance", "Probabilidad de salto evasivo (%)");
        provider.addTranslation("yacl3.config.ait:server.handlesRejectWarningChance", "Probabilidad de aviso de Handles a REJECT (%)");
        provider.addTranslation("yacl3.config.ait:server.handlesZeroLoyaltyRejectWarningChance", "Probabilidad de aviso de Handles con lealtad cero (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentCamouflageChance", "Probabilidad de camuflaje temporal (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentCloakChance", "Probabilidad de ocultación temporal (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentLeftBehindChance", "Probabilidad de abandonar jugadores REJECT (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingChance", "Probabilidad de aterrizaje inseguro (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentFailedEventGravityChance", "Probabilidad de reacción gravitatoria tras un fallo (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentKeyBurnChance", "Probabilidad de quemar una llave vinculada (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentKeyFireSeconds", "Duración del fuego de la llave (segundos)");
        provider.addTranslation("yacl3.config.ait:server.temperamentDoorCloseChance", "Probabilidad de cerrar la puerta ante REJECT (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentDoorEntryTriggerRadius", "Radio de bloqueo de entrada REJECT (bloques)");
        provider.addTranslation("yacl3.config.ait:server.temperamentGravityDurationSeconds", "Duración de la reacción gravitatoria (segundos)");
        provider.addTranslation("yacl3.config.ait:server.temperamentBrokenKeyLoyaltyPenalty", "Penalización de lealtad por llave rota");
        provider.addTranslation("yacl3.config.ait:server.temperamentHammerCooldownTicks", "Recarga de la reacción al martillo (ticks)");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingHorizontalRadius", "Radio horizontal del aterrizaje inseguro");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingVerticalRadius", "Radio vertical del aterrizaje inseguro");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingColumnAttempts", "Intentos de columna para aterrizaje inseguro");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingLocalColumnAttempts", "Intentos locales para aterrizaje inseguro");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingHostileAttempts", "Intentos de encontrar hostiles al aterrizar");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingHostileCaptureRadius", "Radio de captura de hostiles al aterrizar");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingVoidHeight", "Altura de vacío para aterrizaje inseguro");
        provider.addTranslation("yacl3.config.ait:server.temperamentUnsafeLandingBuildLimitMargin", "Margen del límite de construcción al aterrizar");
        provider.addTranslation("yacl3.config.ait:server.temperamentPassiveLoyaltyLossChance", "Probabilidad de pérdida pasiva de lealtad REJECT (%)");
        provider.addTranslation("yacl3.config.ait:server.temperamentPassiveLoyaltyLoss", "Pérdida pasiva de lealtad REJECT");
        provider.addTranslation("yacl3.config.ait:server.temperamentJealousyAbsenceMinutes", "Tiempo de ausencia para provocar celos (minutos)");
        provider.addTranslation("yacl3.config.ait:server.temperamentJealousySameOrLowerPenalty", "Penalización por celos de lealtad igual o menor");
        provider.addTranslation("yacl3.config.ait:server.temperamentJealousyHigherPenalty", "Penalización por celos de lealtad superior");
        provider.addTranslation("yacl3.config.ait:server.temperamentHomeRelocationLoyaltyPenalty", "Penalización de lealtad por trasladar el hogar");
        provider.addTranslation("yacl3.config.ait:server.temperamentHomeOverlapLoyaltyPenalty", "Penalización de lealtad por hogares solapados");
        provider.addTranslation("yacl3.config.ait:server.temperamentHomeOverlapPenaltyIntervalSeconds", "Intervalo de penalización por hogares solapados (segundos)");
        provider.addTranslation("yacl3.config.ait:server.temperamentConsoleRejectionPushHorizontal", "Fuerza horizontal de rechazo de la consola");
        provider.addTranslation("yacl3.config.ait:server.temperamentConsoleRejectionPushVertical", "Fuerza vertical de rechazo de la consola");
        provider.addTranslation("yacl3.config.ait:server.timelineErasureEnabled", "Activar Borrado de la línea temporal");
        provider.addTranslation("message.ait.handles.reject_warning", "Yo no pondría a prueba su paciencia ahora mismo.");
        provider.addTranslation("death.attack.timeline_erasure", "%1$s fue borrado de la línea temporal");
