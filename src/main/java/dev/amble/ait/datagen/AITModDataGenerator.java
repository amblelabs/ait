...
public class AITModDataGenerator implements DataGeneratorEntrypoint {
    ...
    public AmbleLanguageProvider addEnglishTranslations(FabricDataOutput output,
        ...
        provider.addTranslation("yacl3.config.ait:server.category.artron", "Artron");
        ...
        provider.addTranslation("yacl3.config.ait:server.riftChunkMinArtron", "Minimum Artron per Rift Chunk");
        provider.addTranslation("yacl3.config.ait:server.riftChunkMinArtron.desc",
                "Minimum capacity assigned to a new Rift Chunk, in AU. It cannot exceed the maximum.");
        provider.addTranslation("yacl3.config.ait:server.riftChunkMaxArtron", "Maximum Artron per Rift Chunk");
        provider.addTranslation("yacl3.config.ait:server.riftChunkMaxArtron.desc",
                "Maximum capacity assigned to a new Rift Chunk, in AU. It cannot be lower than the minimum.");
        provider.addTranslation("yacl3.config.ait:server.riftChunkArtronRegenPerSecond",
                "Rift Chunk Artron Regeneration");
        provider.addTranslation("yacl3.config.ait:server.riftChunkArtronRegenPerSecond.desc",
                "Artron regenerated by each Rift Chunk per second, in AU/s.");
        provider.addTranslation("yacl3.config.ait:server.tardisAmbientRefuelPerSecond",
                "TARDIS Ambient Refueling");
        provider.addTranslation("yacl3.config.ait:server.tardisAmbientRefuelPerSecond.desc",
                "Base Artron generated per second while a landed TARDIS is refueling, in AU/s.");
        provider.addTranslation("yacl3.config.ait:server.tardisRiftRefuelBonusPerSecond",
                "TARDIS Rift Chunk Refueling Bonus");
        provider.addTranslation("yacl3.config.ait:server.tardisRiftRefuelBonusPerSecond.desc",
                "Additional Artron extracted from a Rift Chunk per second while refueling. This is added to the ambient rate and limited by the chunk's stored Artron.");
    ...
    public AmbleLanguageProvider addSpanishTranslations(FabricDataOutput output,
        ...
        provider.addTranslation("yacl3.config.ait:server.category.artron", "Artrón");
        ...
        provider.addTranslation("yacl3.config.ait:server.riftChunkArtronRegenPerSecond", "Regeneración de Artrón del Rift Chunk");
        provider.addTranslation("yacl3.config.ait:server.riftChunkArtronRegenPerSecond.desc", "Artrón que regenera cada Rift Chunk por segundo, en AU/s.");
        provider.addTranslation("yacl3.config.ait:server.riftChunkMaxArtron", "Artrón máximo por Rift Chunk");
        provider.addTranslation("yacl3.config.ait:server.riftChunkMaxArtron.desc", "Capacidad máxima de Artrón asignada a un Rift Chunk nuevo, en AU. No puede ser inferior al mínimo.");
        provider.addTranslation("yacl3.config.ait:server.riftChunkMinArtron", "Artrón mínimo por Rift Chunk");
        provider.addTranslation("yacl3.config.ait:server.riftChunkMinArtron.desc", "Capacidad mínima de Artrón asignada a un Rift Chunk nuevo, en AU. No puede superar el máximo.");
        ...
        provider.addTranslation("yacl3.config.ait:server.tardisAmbientRefuelPerSecond", "Repostaje ambiental de la TARDIS");
        provider.addTranslation("yacl3.config.ait:server.tardisAmbientRefuelPerSecond.desc", "Artrón base generado por segundo mientras una TARDIS aterrizada está repostando, en AU/s.");
        provider.addTranslation("yacl3.config.ait:server.tardisRiftRefuelBonusPerSecond", "Repostaje adicional en Rift Chunk");
        provider.addTranslation("yacl3.config.ait:server.tardisRiftRefuelBonusPerSecond.desc", "Artrón adicional extraído por segundo del Rift Chunk mientras se reposta. Se suma a la tasa ambiental y está limitado por el Artrón almacenado en el chunk.");
