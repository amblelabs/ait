...
public abstract class ClassicBoxVariant extends ExteriorVariantSchema {
    ...
    public Vec3d adjustPortalPos(Vec3d pos, byte direction) {
        return switch (direction) {
            case 0 -> pos.add(0, -0.08, -0.599); // NORTH
            case 1, 2, 3 -> pos.add(0.45f, -0.08, -0.45f); // NORTH EAST p n
            case 4 -> pos.add(0.599, -0.08, 0); // EAST
            case 5, 6, 7 -> pos.add(0.45f, -0.08, 0.45f); // SOUTH EAST p p
            case 8 -> pos.add(0, -0.08, 0.599); // SOUTH
            case 9, 10, 11 -> pos.add(-0.45f, -0.08, 0.45f); // SOUTH WEST n p
            case 12 -> pos.add(-0.599, -0.08, 0); // WEST
            case 13, 14, 15 -> pos.add(-0.45f, -0.08, -0.45f); // NORTH WEST n n
            default -> pos;
        };
    }
