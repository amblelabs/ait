...
public class RiftRipperRenderer<T extends RiftRipperBlockEntity> implements BlockEntityRenderer<T> {
    ...
    public void render(RiftRipperBlockEntity entity, float tickDelta, MatrixStack matrices,
        ...
        Text text1 = Text.translatable("block.ait.rift_ripper.screen.title");
        Text text2 = Text.translatable("block.ait.rift_ripper.screen.systems_version");
        String bar = "[##########] 100%";
        Text text3 = Text.translatable("block.ait.rift_ripper.screen.rift_held");
