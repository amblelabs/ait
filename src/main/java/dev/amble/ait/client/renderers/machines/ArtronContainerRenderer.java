...
public class ArtronContainerRenderer<T extends ArtronContainerBlockEntity> implements BlockEntityRenderer<T> {
    ...
    public ArtronContainerRenderer(BlockEntityRendererFactory.Context ctx) {
        this.artronCollectorModel = new ArtronCollectorModel(ArtronCollectorModel.getTexturedModelData().createModel());
    }

    @Override
    public void render(ArtronContainerBlockEntity entity, float tickDelta, MatrixStack matrices,
