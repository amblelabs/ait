...
public class CoralSeatRenderer implements BlockEntityRenderer<CoralSeatBlockEntity> {

    private final CoralSeatModel model;

    public CoralSeatRenderer(BlockEntityRendererFactory.Context ctx) {
        this.model = new CoralSeatModel(CoralSeatModel.getTexturedModelData().createModel());
    }

    @Override
    public void render(CoralSeatBlockEntity entity, float tickDelta, MatrixStack matrices,
        ...
        Identifier texture = new Identifier(AITMod.MOD_ID, "textures/blockentities/decoration/coral_seat.png");
