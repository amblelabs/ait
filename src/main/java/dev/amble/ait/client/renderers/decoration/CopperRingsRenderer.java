...
public class CopperRingsRenderer implements BlockEntityRenderer<CopperRingsBlockEntity> {

    private final CopperRingsModel model;

    public CopperRingsRenderer(BlockEntityRendererFactory.Context ctx) {
        this.model = new CopperRingsModel(CopperRingsModel.getTexturedModelData().createModel());
    }

    @Override
    public void render(CopperRingsBlockEntity entity, float tickDelta, MatrixStack matrices,
        ...
        Identifier texture = new Identifier(AITMod.MOD_ID, "textures/blockentities/decoration/copper_rings.png");
