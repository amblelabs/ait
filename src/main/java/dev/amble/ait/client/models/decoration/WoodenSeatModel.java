...
public class WoodenSeatModel extends SinglePartEntityModel {
	...
	public WoodenSeatModel(ModelPart root) {
		this.chair = root.getChild("WoodenSeatModel");
	}
	public static TexturedModelData getTexturedModelData() {
		ModelData modelData = new ModelData();
		ModelPartData modelPartData = modelData.getRoot();
		ModelPartData chair = modelPartData.addChild("WoodenSeatModel", ModelPartBuilder.create().uv(0, 0).cuboid(-8.0F, 6.6617F, -15.6515F, 16.0F, 3.0F, 16.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 9.3383F, 7.6515F));
