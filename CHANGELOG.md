...
- chore: AIT requires 1.1.15+ version of amblekit. | by [@drtheodor](https://github.com/drtheodor) ([#1936](https://github.com/amblelabs/ait/pull/1936))
...
- fix: staser bolt for devs maybe idrk | by [@vmbbi](https://github.com/vmbbi) ([#2022](https://github.com/amblelabs/ait/pull/2022))
...
- fix: you can demat after cancelling reconfiguration | by [@drtheodor](https://github.com/drtheodor) ([#2120](https://github.com/amblelabs/ait/pull/2120))
...
- fix: finalize Repair Tool Functionality | by [@Loqor](https://github.com/Loqor) ([#2137](https://github.com/amblelabs/ait/pull/2137))
...
- fix: when handles/a sonic are in the sonic port, they got replaced if you were holding a sonic or handles. | by [@Loqor](https://github.com/Loqor) ([#2141](https://github.com/amblelabs/ait/pull/2141))
...
- cleanup: remove FIND_PLAYER packet | by [@Loqor](https://github.com/Loqor) ([#2149](https://github.com/amblelabs/ait/pull/2149))
...
- fix: Interior Reconfiguration Issues | by [@Loqor](https://github.com/Loqor) ([#2154](https://github.com/amblelabs/ait/pull/2154))
...
- feat: Sound Changes | by [@Loqor](https://github.com/Loqor) ([#2159](https://github.com/amblelabs/ait/pull/2159))
...
- perf: TARDIS interiors and exteriors render far faster. A copper console interior runs at about three times the frame rate, and forty exteriors on screen at about one and three quarters | by [@duzos](https://github.com/duzos) ([#2186](https://github.com/amblelabs/ait/pull/2186))
- perf: consoles, doors and exteriors were each drawn twice every frame, and were drawn at all while behind the camera | by [@duzos](https://github.com/duzos) ([#2186](https://github.com/amblelabs/ait/pull/2186))
- perf: consoles no longer submit the parts of themselves that cannot light up on the glow pass | by [@duzos](https://github.com/duzos) ([#2186](https://github.com/amblelabs/ait/pull/2186))
- perf: console monitor text is drawn once rather than nine times | by [@duzos](https://github.com/duzos) ([#2186](https://github.com/amblelabs/ait/pull/2186))
- perf: console animation no longer re-searches the whole model for every moving part each frame | by [@duzos](https://github.com/duzos) ([#2186](https://github.com/amblelabs/ait/pull/2186))
- fix: the server no longer crashes when a TARDIS that has never flown is given a destination | by [@duzos](https://github.com/duzos) ([#2186](https://github.com/amblelabs/ait/pull/2186))
